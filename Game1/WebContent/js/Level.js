...
Level.prototype.create = function() {
    ...
    this.music.play() ;
	 ...
	 this.map = this.game.add.tilemap("bbbb");
...
Level.prototype.addSkel = function(x1, y) {
...
Level.prototype.addPlayer = function(x1, y) {
...
Level.prototype.addGoal = function(x, y) {
	var t = this.add.sprite(x+200, y-100, "door");
	t.scale.x=0.25;
	t.scale.y=0.25;
...
Level.prototype.onCollideGate=function(p, x){
	//function ชน โกล
	p.damage(1);
...
Level.prototype.onCollideBullet=function(b, e){
	//กระสุนชนผี
	e.kill();
	b.kill();
